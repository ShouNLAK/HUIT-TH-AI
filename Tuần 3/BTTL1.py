...
class TicTacToeMinimax:
    def __init__(self, size=3, win_streak=3, max_depth=None, verbose=True, max_log_depth=6, log_board=False):
        self.N = size
    ...
    def finish(self, board):
        """Kiểm tra kết thúc trò chơi. Trả về 'X', 'O', 'Tie' hoặc None"""
    ...
    def minimax(self, board, depth, is_maximizing):
        """Thuật toán Minimax cơ bản duyệt toàn bộ không gian trạng thái"""
